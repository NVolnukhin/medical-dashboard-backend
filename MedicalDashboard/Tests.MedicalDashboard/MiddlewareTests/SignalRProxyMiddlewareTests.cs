...
public class SignalRProxyMiddlewareTests
{
    private readonly Mock<ILogger<SignalRProxyMiddleware>> _loggerMock = new();
    ...
    [Fact]
    public async Task InvokeAsync_CallsNext_ForNonSignalRPath()
    {
        var context = CreateHttpContext("/api/other");
        var nextCalled = false;
        var middleware = new SignalRProxyMiddleware(_ => { nextCalled = true; return Task.CompletedTask; }, _loggerMock.Object, _configMock.Object);
    ...
    {
        var context = CreateHttpContext("/hubs/metrics", "OPTIONS");
        var middleware = new SignalRProxyMiddleware(_ => Task.CompletedTask, _loggerMock.Object, _configMock.Object);
        await middleware.InvokeAsync(context);
    ...
    {
        var context = CreateHttpContext("/hubs/metrics");
